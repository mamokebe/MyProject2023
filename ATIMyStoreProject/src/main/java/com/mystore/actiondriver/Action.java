...
public class Action extends BaseClass implements ActionInterface {
	 ...
	 * WebDriverWait(driver,15).until(ExpectedConditions.visibilityOfElementLocated(
	 * By.xpath("//iframe")) ); driver.switchTo().frame(index); flag = true; return
